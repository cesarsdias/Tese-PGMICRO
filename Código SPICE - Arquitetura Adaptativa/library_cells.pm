...
.subckt  BUFFER2  in vdd vss out		
								
Mp1  outx  in  vdd  vdd  PMOS350 w=1.5u  l=350n	
Mn1  outx  in  vss  vss  NMOS350 w=1.5u  l=350n
Mp2  out   outx  vdd  vdd  PMOS350 w=3u  l=350n	
Mn2  out   outx  vss  vss  NMOS350 w=3u  l=350n
...
*Eout x vss vol = '300e3*v(plus,minus) > v(vdd) ? {v(vdd)} : 300e3*v(plus,minus) < 0 ? {0}:300e3*v(plus,minus)'
